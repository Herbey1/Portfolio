const translations = {
  es: {
    ...
    role: "Estudiante de Ingeniería de Software y Tecnologías Emergentes",
    tagline: "Explorando el desarrollo frontend y soñando con bases de datos y ciberseguridad",
    ...
    bio:
      "Soy estudiante de la Universidad Autónoma de Baja California en la Facultad de Ciencias Químicas e Ingeniería. Me apasiona la programación, especialmente el desarrollo frontend, aunque también me interesa aprender más sobre bases de datos y ciberseguridad. Me gusta probar cosas nuevas, practicar voleibol y, en mis ratos libres, disfruto dibujar y pintar.",
    projects: {
      sgca: {
        title: "Sistema de Gestión de Comisiones Académicas (SGCA – UABC)",
        desc: "Aplicación para automatizar y optimizar comisiones académicas en FCQI UABC.",
      },
      ecogestor: {
        title: "EcoGestor",
    ...
    cv: {
      ...
      edu_univ_dates: "Ago 2021 — Presente",
      edu_univ_semester: "Semestre: 8º",
      edu_univ_gpa: "Promedio: 87.25",
      edu_univ_grad: "Graduación esperada: Junio 2026",
      ...
      list_languages: "Lenguaje C, Java, JavaScript, Python, Lenguaje ensamblador (básico)",
      ...
      sgca_2: "Prototipo académico en Java/Swing con MySQL y UML.",
  ...
  en: {
    ...
    cv: {
      ...
      edu_univ_dates: "Aug 2021 — Present",
